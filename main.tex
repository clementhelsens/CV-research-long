...
%\vskip 0.2 cm
%\noindent
%Please find below my curriculum vitae and a chosen list of presentations given at conferences, workshop and seminars. \\
%%Please find below my curriculum vitae, a chosen list of presentations given at conferences, workshop and seminars and a statement of research interest. \\

%\noindent
%The three letters of recommendation will be provided by:
%%The three letters of recommendation could be provided on demand by:
%\vskip 1.0 cm


%\begin{enumerate}
%\item Claude Guyot \\
%  Institut de Recherche sur les Lois Fondamentale de l'Univers (IRFU) \\
...
%  E-mail: claude.guyot@cea.fr \\

%\item Richard  Hawkings\\
%Organisation européenne pour la Recherche nucléaire (CERN)\\
%385 Route de Meyrin\\
%1217 Meyrin, Switzerland\\
% E-mail: richard.hawkings@cern.ch\\

%\item Aurelio Juste\\
% Institut de Fisica d'Altes Energies (IFAE)\\
% Edifici Cn, Facultat de Ciencies\\
...
% \tab  \tab  ATLAS underground escort guide;
...
%\begin{itemize}
%\itemsep0em
%\item[] Programming in C, C++, Python, xml, shell. 
%%\item[] Mac and LINUX operating systems: many programs on these platforms.
%%\item[] Analysis and application software, such as ROOT, ROOFIT, ROOSTAT, Geant4, TMVA.
%\item[] Physics software, such as ROOT, RooFit, RooStat, Geant4, TMVA.
%\item[] Code management with SVN, Git.
%\end{itemize}
...
%\item[] English \tab : Written and spoken fluently
%\item[] German \tab : Written and spoken fluently
%\item[] Japanese \tab : Beginner 
%\end{itemize}
...
%\begin{itemize}
%\itemsep0em
%\item[] CERN official guide
%\item[] ATLAS underground escort guide
%\item[] Volunteer for various CERN events such as:  Passeport Big Bang, Open days
%\end{itemize}
...
%\vskip 0.2cm
%In the following, a short summary of my research activities is given.
\vskip 0.2cm
%\hskip 0.5cm {\bf As member of the ATLAS Experiment, CERN, Geneva, Switzerland}\\
...
\vspace{2.5mm}
%One of the main challenges for the good performance of the MS is to determine the position and movement of the muon chambers. A complex optical system is 
%used to measure their relative movements, while to obtain a reference geometry straight tracks are needed. 
%%Relative alignment is achieved using a complex optical system, while for absolute alignment straight tracks are needed. 
%Straight muons can be obtained taking cosmic or collision data without toroidal magnetic field. 
%When taking collision data without toroidal field, all the straight tracks will be reconstructed in the MS as high $p_T$ muons, as only the multiple 
%scattering will play a role in smearing their trajectory. The level-1 trigger logic is based on measuring the deviation in the magnetic field, and in 
%absence of field this level-1 trigger logic could be saturated by low $p_T$ muons.
%\vspace{2.5mm}
...
% documented in an internal note.
...
%The high center of mass energy of the LHC and the small expected backgrounds allows for an early discovery of such signals with relatively low integrated luminosity. 
%For this purpose I developed a sophisticated statistical method which was adopted by the exotics physics group. As for muons of high momentum, 
%the Muon Spectrometer (MS) momentum resolution is dominated by the misalignment, I have participated in detailed studies to assess the impact of this effect on $Z^{\prime}$ 
%search sensitivity. The full analysis has been published in [1]. I also derived a parametrization of the MS misalignment 
%in the detector simulation, and made it available to others as an official tool, documented in an internal note.
%I participated in hardware activities in the ATLAS cavern with the 
%commissioning of the optical alignment system of the barrel MS.
...
% with two different technologies, sTGC and Micromegas. It is the most ambitious project involving Micromegas detector ever proposed.
...
%company to ship the material to install and test the final
%mechanical structure in the coming month.
\vspace{2.5mm}
...
%\item[] CERN is undertaking a full design study for post-LHC particle accelerator options in a global context. The Future Circular Collider (FCC) study 
%has an emphasis on hadron-hadron (FCC-hh), electron-positron (FCC-ee) and electron-hadron (FCC-eh) high-energy frontier machines. 
%The study is exploring the potential of such colliders in terms of physics reach as well as infrastructure and operation concepts 
%and considering the technology research and development programs that would be required to build a future circular collider. 
...
\> {\bf Henri Bachacou}  \> 2014 \> Thesis advisor  \\
\> {\bf Daniel Froidevaux}  \> 2018 \> Previous physics group leader at CERN  \\
\> {\bf Richard Hawkings}  \> - \>  Physics group leader at CERN\\
\> {\bf Paolo Iengo}  \> 2016 \>  Supervisor for the NSW hardware project\\
\> {\bf Aurelio Juste}  \> 2015 \>  Supervisor at IFAE\\
\> {\bf Alison Lister}  \> 2015 \>  ATLAS top convener \\
\> {\bf Michelangelo Mangano}  \> - \> Study coordinator of FCC-hh\\
\> {\bf Werner Riegler}  \> - \> Study coordinator of FCC-hh\\
\> {\bf Martine Bosman}  \> 2013 \>  Group leader of IFAE \\
\> {\bf Claude Guyot} \> 2009 \>  Thesis director  
